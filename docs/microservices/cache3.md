...
![image-20230421102213146](https://czh-wp.oss-cn-hangzhou.aliyuncs.com/img/202304211022490.png)
...
在 czh-question 微服务的 pom.xml 引入 redisson的 maven 依赖。
...
我们用 czh-project 这个开源项目测试下可重入锁的两个点：
...
![img](https://czh-wp.oss-cn-hangzhou.aliyuncs.com/img/202304211024183.png)
...
![image-20230421102439143](https://czh-wp.oss-cn-hangzhou.aliyuncs.com/img/202304211024781.png)
...
![image-20230421102620537](https://czh-wp.oss-cn-hangzhou.aliyuncs.com/img/202304211026225.png)

当服务器宕机后，因为锁的有效期是 30 秒，所以会在 30 秒内自动解锁。（30秒等于宕机之前的锁占用时间+后续锁占用的时间）。

如下图所示：

![image-20230421102700396](https://czh-wp.oss-cn-hangzhou.aliyuncs.com/img/202304211027296.png)
...
![image-20210521102640573](https://czh-wp.oss-cn-hangzhou.aliyuncs.com/img/202304211027634.png)
...
![image-20230421102756823](https://czh-wp.oss-cn-hangzhou.aliyuncs.com/img/202304211027461.png)
...
![image-20230421102910771](https://czh-wp.oss-cn-hangzhou.aliyuncs.com/img/202304211029547.png)
...
![image-20230421102949577](https://czh-wp.oss-cn-hangzhou.aliyuncs.com/img/202304211029951.png)
...
![image-20230421103027914](https://czh-wp.oss-cn-hangzhou.aliyuncs.com/img/202304211030301.png)

然后用 postman 发送 park 请求占用一个停车位。

![image-20230421103153784](https://czh-wp.oss-cn-hangzhou.aliyuncs.com/img/202304211031004.png)
