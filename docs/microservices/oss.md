...
![上传图片](https://czh-wp.oss-cn-hangzhou.aliyuncs.com/img/202304181623149.gif)

每个 OSS 的用户都会用到上传服务。Web 端常见的上传方法是用户在浏览器或 APP 端上传文件到应用服务器，应用服务器再把文件上传到 OSS。具体流程如下图所示。 ![具体流程](https://czh-wp.oss-cn-hangzhou.aliyuncs.com/img/202304181623600.png)
...
![原理介绍](https://czh-wp.oss-cn-hangzhou.aliyuncs.com/img/202304181623360.png)
...
![登录阿里云官网](https://czh-wp.oss-cn-hangzhou.aliyuncs.com/img/202304181628259.png)

- 创建Bucket 存储桶

  ![创建Bucket 存储桶](https://czh-wp.oss-cn-hangzhou.aliyuncs.com/img/202304181623649.png)

- 获取accesskey id和secret

![获取accesskey id和secret](https://czh-wp.oss-cn-hangzhou.aliyuncs.com/img/202304181623243.png)

![获取accesskey id和secret](https://czh-wp.oss-cn-hangzhou.aliyuncs.com/img/202304181623211.png)

![获取accesskey id和secret](https://czh-wp.oss-cn-hangzhou.aliyuncs.com/img/202304181629107.png)

- 分配权限

  分配 管理对象存储服务（OSS）权限

  ![分配权限](https://czh-wp.oss-cn-hangzhou.aliyuncs.com/img/202304181623093.png)
...
![上传成功](https://czh-wp.oss-cn-hangzhou.aliyuncs.com/img/202304181624912.png)

## [4.获取服务端签名]

### [4.1 准备工作：]

- 创建一个第三方服务czh-thirdparty
- 引入czh-common模块，并且排除mybatis-plus依赖
...
spring.cloud.nacos.config.namespace=czh-thirdparty
...
![配置oss.yml](https://czh-wp.oss-cn-hangzhou.aliyuncs.com/img/202304181629443.png)
...
public class CzhThirdpartyApplication {
    public static void main(String[] args) {
        SpringApplication.run(CzhThirdpartyApplication.class, args);
    }
}
```
    ...
    gateway:
      routes:
        - id: route_thirdparty # 题目微服务路由规则
          uri: lb://czh-thirdparty # 负载均衡，将请求转发到注册中心注册的assjava-thirdparty服务
          predicates: # 断言
...
![配置跨域访问](https://czh-wp.oss-cn-hangzhou.aliyuncs.com/img/202304181630411.png)
...
![上传图片](https://czh-wp.oss-cn-hangzhou.aliyuncs.com/img/202304181630624.gif)
